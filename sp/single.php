<?php
   ...
   function h($s) {
	...
	try {
        ...
        //get contents
		$stmt = $dbh->prepare("select * from contents where id=:id AND public=1");
		...
		//get contents
		$stmt3 = $dbh->prepare("select * from relations where contents_id=:id");
...
<head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb#">
    ...
    <meta charset="UTF-8">
    <title><?= $get_contents["title"]; ?> | mono studio[モノスタジオ]</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name=viewport content="width=device-width, initial-scale=1">
    <meta name="description" content="<?= $description; ?>">
    <meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:site" content="@monostudio_jp">
	<meta name="twitter:title" content="<?= $get_contents["title"]; ?> | mono studio[モノスタジオ]">
	<meta name="twitter:description" content="<?= $description; ?>">
	<meta name="twitter:image" content="">
    <meta property="fb:app_id" content="180196992327206">
    <meta property="og:locale" content="ja_JP">
    <meta property="og:title" content="<?= $get_contents["title"]; ?> | mono studio[モノスタジオ]">
	...
	<link rel="canonical" href="https://monostudio.jp/<?= $get_contents["id"]; ?> ">
...
<body class="lists-show" data-pinterest-extension-installed="cr1.39.1">
<!-- Google Tag Manager -->
...
<article class="article" data-category="lifestyle">
  

<script>!function(e,t){var n=t.getElementsByClassName("cover")[0];if(n){n.style.maxHeight="300px";var i=function(){n.style.height=Math.round(.5625*e.innerWidth)+"px"};i(),e.addEventListener("resize",i,!1)}}(window,document);
</script>
  
<div class="header">
	<p class="update" itemprop="dateModified" content="<?= $get_date_content; ?>"><?= $get_date; ?></p>
		
    <h1 class="title"><?php echo $get_contents["title"]; ?></h1>

			
	<p class="description"><?php echo $get_contents["intro"]; ?></p>
	<!--<p class="buy_button"><a href="#" class="buy"></a></p>-->
    ...
    <div class="action">
      ...
      <ul class="share-buttons">
        <li class="twitter">
          <a href="https://twitter.com/share" data-via="monostudio_jp" data-lang="ja"><span class="icon icon-twitter"></span></a>
        </li>

        <li class="facebook">
          <a href="" target="_blank"  data-page="1" data-position="upper">
    ...
    <div class="js-listContent" style="">
        <div class="content content-data" data-list-id="179165" data-page="1">
			<ul id="list_content">
				...
				<?php if($main["type"] == "title"){ ?>
					...
					<!--タイトルの場合-->
					<li class="x-content-area" data-item-id="4507119" data-item-type="">
						<h2 style="border-color:#0096CC" class="article_headline"><?= $main["content"]; ?></h2>				
					</li>
				...
				<?php }elseif($main["type"] == "img"){ ?>
					...
					<li class="x-content-area" data-item-id="27421" data-item-type="Image">
						<img class="x-article-image" src="<?= $main["content"]; ?>" />
						<p class="rel">出典：
							<a href="<?= $main["ref"]; ?>" target="_blank" rel="nofollow"><?= $main["ref"]; ?></a>
						</p>
					</li>
  ...
  <section class="content-area tag-cloud">
    <h2 class="title_section">関連キーワード</h2>
    <ul>
	  <?php while($tag = $stmt3->fetch(PDO::FETCH_ASSOC)){  ?>
	  <?php
		  //get tags
		$stmt = $dbh->prepare("select * from tags where id=:id");
	    $stmt->execute(array(":id"=>$tag['tag_id']));
	    $get_tags = $stmt->fetch();
	  ?>
      <li>
        <a href="tags-<?= $get_tags["id"]; ?>"><span><?= $get_tags["tag_title"]; ?></span></a>
      </li>
      <?php } ?>
    </ul>
  </section>
...
<div id="articleListAnalyse"></div>
<section id="related" class="content-area article_list">
<h2 class="title_section">人気記事一覧</h2>
	<div id="js-renderedRelatedList" data-list-id="179165" data-user-group="group_dena_5" data-additional-list="false">
		<ul>
	    <?php while($top_popular_contents_get = $top_popular_contents->fetch(PDO::FETCH_ASSOC)){  ?>
			<li>
				<a href="<?= $top_popular_contents_get["id"]; ?>" >
				<div class="list_thumb">
					<span class="crop_image" style="display:block;width:110px;height:70px;vertical-align:middle;background-image:url(<?= $top_popular_contents_get["top_img"]; ?>);background-color:rgb(245, 245, 245);background-size:cover;background-position:50% 50%;background-repeat:no-repeat;"></span>
				</div>
				<div class="list_content">
					...
					<?php
					    ...
					    $stmt->execute(array(":id"=>$tag['writer_id']));
					    $get_writers = $stmt->fetch();
						
					?>
					<div class="list_info">
						<p class="author">
							<span><?= $get_writers; ?></span>
						</p>
					</div>
				</div>
				</a>
...
<section class="content-area category-list">
  ...
  <ul>
    ...
    <p class="m-footer-sns">
      <a href="https://www.facebook.com/MERY.info" target="_blank">
        <span class="icon icon-footer-facebook"></span>
      </a>
       <a href="https://twitter.com" target="_blank"><span class="icon icon-footer-twitter"></span></a>
    </p>
  ...
  <p class="m-footer-copyright">Copyright© mono studio, Inc. All Rights Reserved.</p>
